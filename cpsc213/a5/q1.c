...
void q1() {
  v0 = a->x[i]; // 4 reads and 1 writes (a, a->x, a->x[], a->x[i])
  v1 = a->b.y[i]; // 1 reads and 1 writ
  v2 = a->b.a->x[i]; // 3 reads and 1 writes
  a->b.a = a; // 0 reads and 1 writes
  v3 = a->b.a->b.y[i]; // 0 reads and 1 writes
}
  // 20 reads and 1 writes
